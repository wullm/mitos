...
int main(int argc, char *argv[]) {
    ...
    if (rank == 0) {
        ...
        fftwf_complex *fbox1 = (fftwf_complex*) fftwf_malloc(N*N*(N/2+1)*sizeof(fftwf_complex));
        fftwf_complex *fbox2 = (fftwf_complex*) fftwf_malloc(N*N*(N/2+1)*sizeof(fftwf_complex));
